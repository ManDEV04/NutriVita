...
>
    ...
    <div class="hero-light light-one"></div>
    <div class="hero-light light-two"></div>

    {{-- DECORACIÓN NUTRICIONAL: solo visual, no cambia funcionalidad --}}
    <div class="nutrition-decor nutrition-decor--top-left" aria-hidden="true">
        <img src="{{ asset('images/landing/nutri-decor/avocado-blueberries.png') }}" alt="">
    </div>

    <div class="nutrition-decor nutrition-decor--left" aria-hidden="true">
        <img src="{{ asset('images/landing/nutri-decor/left-greens.png') }}" alt="">
    </div>

    <div class="nutrition-decor nutrition-decor--top-right" aria-hidden="true">
        <img src="{{ asset('images/landing/nutri-decor/lime-herbs.png') }}" alt="">
    </div>

    <div class="nutrition-decor nutrition-decor--right" aria-hidden="true">
        <img src="{{ asset('images/landing/nutri-decor/right-vegetables.png') }}" alt="">
    </div>
